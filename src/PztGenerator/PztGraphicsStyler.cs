...
internal static class PztGraphicsStyler
{
    ...
    [
        ...
        new("Dojazdy utwardzone", PztCategories.AccessRoad, string.Empty, "pztGen_dojazdy", new Color(185, 185, 185), new Color(95, 95, 95), 3, PztLinePatternKind.Solid, "Szare wypelnienie i ciagla obwiednia dojazdu utwardzonego"),
        new("Powierzchnia gruntowa", PztCategories.GroundSurface, string.Empty, "pztGen_pow_gruntowa", new Color(218, 235, 197), new Color(110, 140, 80), 2, PztLinePatternKind.Dashed, "Jasnozielone wypelnienie; wliczana do dojazdow, bez pomniejszania PBC"),
        ...
        new("Place", PztCategories.Square, string.Empty, "pztGen_place", new Color(176, 176, 176), new Color(85, 85, 85), 3, PztLinePatternKind.Solid, "Szare wypelnienie i ciagla obwiednia placu"),
        new("Schody terenowe", PztCategories.TerrainStairs, string.Empty, "pztGen_schody_terenowe", new Color(198, 198, 198), new Color(95, 95, 95), 2, PztLinePatternKind.Solid, "Szare wypelnienie i ciagla obwiednia schodow terenowych"),
