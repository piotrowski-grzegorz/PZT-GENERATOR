...
Sprawdzamy workflow i logike bilansu PZT w prototypie `0.2.6-mvp-test` dla Revit 2025.03. To nie jest narzedzie do finalnej dokumentacji ani rozliczen formalnych.

## Przed testem

- Zainstaluj wtyczke z paczki `PztGenerator-0.2.6-mvp-test-installer.zip`.
