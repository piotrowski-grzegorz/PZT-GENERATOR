...
- Wersja prototypu: `0.2.3-mvp-test`
- Revit: 2025 / 2025.03
...
- Prosty instalator testerski ZIP: `dist/PztGenerator-0.2.3-mvp-test-installer.zip`.
...
- MVP-HANDOFF: gotowe do pokazania testerom jako `0.2.3-mvp-test`; dodano instrukcje testera, widoczna informacje o prototypie i eksport DOCX.
...
- GT-009: zakonczony w kodzie; PBC liczy sie automatycznie z granicy dzialki, a stare wartosci typu `Zabudowa istniejaca` sa mapowane do kategorii `Zabudowa` i stanu `Istniejaca`.
